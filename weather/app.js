...
const paletteStops = [
  ...
  },
  {
    ...
    poolA: "rgba(248, 226, 176, 0.08)",
    poolB: "rgba(255, 255, 255, 0.14)",
    horizon: "rgba(236, 247, 255, 0.26)",
    vignetteTop: "rgba(16, 28, 42, 0.015)",
    vignetteBottom: "rgba(16, 28, 42, 0.02)",
  },
  {
    t: 0.5,
    top: "#377fdf",
    mid: "#6eb2ec",
    bottom: "#d8eeff",
    tintTop: "rgba(255, 255, 255, 0.02)",
    tintBottom: "rgba(255, 255, 255, 0)",
    poolA: "rgba(248, 228, 186, 0.07)",
    poolB: "rgba(255, 255, 255, 0.13)",
    horizon: "rgba(230, 244, 255, 0.28)",
    vignetteTop: "rgba(13, 26, 44, 0.01)",
    vignetteBottom: "rgba(13, 26, 44, 0.01)",
  },
  {
    t: 0.72,
    top: "#4472b5",
